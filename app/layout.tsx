...
export const metadata: Metadata = {
  ...
  title: {
    default: 'StickyBits - Premium Anime & Pop Culture Stickers',
    template: '%s | StickyBits',
  },
  ...
  openGraph: {
    title: 'StickyBits - Premium Stickers',
...
import StickyMasterChat from '@/components/StickyMasterChat'
