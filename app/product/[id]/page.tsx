...
export default async function ProductPage({ params }: Props) {
    ...
    console.log('Server Product ID:', product.id);
    console.log('Server pack_stickers length:', product.pack_stickers ? product.pack_stickers.length : 0);
